...
/**
 * Copied from a google library. This is deprecated (because the new version is
 * faster) but i didn't want to disentangle the new version.
 *
...
public final class FastURLEncoder {
    ...
    /**
     * Set this to 'true' if you are not certain that FastURLEncoder is going to
     * do the right thing for you and want to test for a while. Set to 'false'
     * if you want the speed and memory benefits of FastURLEncoder. If this is
     * set to 'true' and FastURLEncoder disagrees with URLEncoder then
     * FastURLEncoder will log a java.util.logging.Level.SEVERE message and
     * return the value provided by URLEncoder.
     */
     ...
     * @param plusForSpace whether octet 0x20, i.e. "space", should be encoded
     * as a plus sign rather than "%20". Note that this parameter is effectively
     * ignored if 0x20 is in safeOctets.
     *
     * @return the encoded version of {@code s}. Will return {@code s} itself if
     ...
     *
     * deprecated Use
     * {@link com.google.gdata.util.common.base.CharEscapers#uriEscaper()} or
     * create an instance of
     * {@link com.google.gdata.util.common.base.PercentEscaper}. See
     * {@link FastURLEncoder} for more details.
     */
     ...
     * escaping all octets not included in safeOctets, and then outputting the
     * result to an Appendable.
     *
     * @param s String to encode.
     * @param encoding character encoding to use (e.g., "UTF-8")
     * @param safeOctets set of octets that should not be escaped.
     ...
     *
     * @return true if {@code s} did need escaping, false otherwise. In other
     * words, this returns false only if {@code s} was output to {@code out}
     * verbatim.
     *
     * @throws UnsupportedEncodingException if {@code encoding} is not
     * supported.
     ...
     *
     * deprecated Use
     * {@link com.google.gdata.util.common.base.CharEscapers#uriEscaper()}. See
     * {@link FastURLEncoder} for more details.
     */
    public static String encode(String s, String encoding)
        ...
        if (verifyAgainstJava) {
            ...
            if (!jresult.equals(result)) {
                LogManager.getLogger().error("FastURLEncoder does not match java. Java: '" + jresult + "'  FastURLEncoder: '" + result + "'");
                return jresult;
            }
        }
    ...
    /**
     * This should be a direct replacement for java.net.URLEncoder.encode(), but
     * appends its output to an Appendable.
     *
     * @see java.net.URLEncoder#encode(String, String)
     * @param s String to encode.
     * @param encoding character encoding to use (e.g., "UTF-8")
    ...
    /**
     * Shortcut for encode(s, "UTF-8"). This is very similiar to
     * java.net.URLEncoder.encode() except that it uses UTF-8 instead of the
    ...
    /**
     * Shortcut for encode(s, "UTF-8", out). This is very similiar to
     * java.net.URLEncoder.encode() except that it uses UTF-8 instead of the
     * platform's default encoding.
     *
     * @see java.net.URLEncoder#encode(String)
     ...
     * the kGoogle1Escape set. To produce the same escaping as C++, use this
     * BitSet with the plusForSpace option.
     *
     * deprecated Use
     * {@link com.google.gdata.util.common.base.CharEscapers#cppUriEscaper()}
     */
     ...
     * {@link java.net.URLEncoder#encode(String)}. Callers can edit the result
