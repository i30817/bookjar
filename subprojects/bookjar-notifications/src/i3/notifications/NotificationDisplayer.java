...
public abstract class NotificationDisplayer {
    ...
    public static enum Priority {
        ...
        HIGH(new ImageIcon(ImageUtilities.loadImage("i3/notifications/resources/priority_high.png"))), //NOI18N
        NORMAL(new ImageIcon(ImageUtilities.loadImage("i3/notifications/resources/priority_normal.png"))), //NOI18N
        LOW(new ImageIcon(ImageUtilities.loadImage("i3/notifications/resources/priority_low.png"))), //NOI18N
        /**
         * Priority that shows the notification without details. Details shall
         * be shown only later, per user request.
         *
         * @since 7.18
         */
        SILENT(new ImageIcon(ImageUtilities.loadImage("i3/notifications/resources/priority_silent.png"))); //NOI18N
    ...
    /**
     * Category of Notification, displayed in Notifications TC. Use one of the
     * defaults categories (INFO, WARNING, ERROR) or create a custom category.
     *
    ...
    /**
     * Looks for an implementation in global Lookup, if none is found then it
     * falls back to a primitive implementation which displays the notifications
     * in main window's status line.
     *
     ...
     *
     * @param title Notification title. Html is not supported, any html tags
     * will be escaped.
     * @param icon Notification icon
     * @param detailsText Detailed description of the notification. If
     * detailsAction is non-null then this text will be presented as a clickable
     * link. Html is not supported, any html tags will be escaped.
     * @param detailsAction Action to invoke when user click details text or
     * null.
     ...
     * null.
     * @param priority Notification priority
     * @param categoryName Notification category name, refers to a custom
     * category created in e.g. layer.xml.
     * @return New notification.
     * @since 7.58
     */
    public Notification notify(String title, Icon icon,
     ...
     * in a balloon.
     * @param popupDetails Component that will show below notification title in
     * notifications list.
     * @param priority Notification priority.
     * @return New notification.
     */
    ...
    /**
     * Simple implementation of NotificationDisplayer which shows the
     * notifications on the main status line.
     */
